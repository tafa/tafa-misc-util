(function() {
  var ALPHABET58, AsyncJoin, ENOTDIR, I, NIBBLES, asciiPrefixOfBuffer, assert, async, check_exec, check_spawn_exec, crypto, endswith, exec, extend, firstTimeOnly, fs, hex_decode, hex_encode, http, intervalSet, invertedDict, joinBuffers, joinBuffersWithFixes, k, keysOf, max, min, noisyExec, noisySpawn, objectKeys, objectSize, parseBash, parsePNM, pathsIn, querystring, random, randomInteger, randomToken, re_escape, readData, readText, replaceExtension, repoContainingPath, rjust, sha256, sha256_first4, spawn, spawn_exec, startswith, test_api_call, timeoutSet, toBuffer, uint16be, uint16le, uint32be, uint32le, v, valuesOf, varintEncodeToOctets, varintsEncode, _pathsIn, _ref, _ref2;
